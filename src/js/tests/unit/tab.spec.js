  ...
  describe('show', () => {
    ...
    it('should not fire shown when tab is already active', done => {
      fixtureEl.innerHTML = [
        ...
        '  <li class="nav__item"><a href="#home" class="nav__link active" role="tab">Home</a></li>',
        '  <li class="nav__item"><a href="#profile" class="nav__link" role="tab">Profile</a></li>',
        '</ul>',
        '<div class="tab__content">',
        '  <div class="tab__pane active" id="home" role="tabpanel"></div>',
        '  <div class="tab__pane" id="profile" role="tabpanel"></div>',
        '</div>'
      ].join('')
    ...
    it('should not fire shown when tab is disabled', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav__tabs" role="tablist">',
        '  <li class="nav__item"><a href="#home" class="nav__link active" role="tab">Home</a></li>',
        '  <li class="nav__item"><a href="#profile" class="nav__link disabled" role="tab">Profile</a></li>',
        '</ul>',
        '<div class="tab__content">',
        '  <div class="tab__pane active" id="home" role="tabpanel"></div>',
        '  <div class="tab__pane" id="profile" role="tabpanel"></div>',
    ...
    it('show and shown events should reference correct relatedTarget', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav__tabs" role="tablist">',
        '  <li class="nav__item"><a href="#home" class="nav__link active" role="tab">Home</a></li>',
        '  <li class="nav__item"><a id="triggerProfile" href="#profile" class="nav__link" role="tab">Profile</a></li>',
        '</ul>',
        '<div class="tab__content">',
        '  <div class="tab__pane active" id="home" role="tabpanel"></div>',
        '  <div class="tab__pane" id="profile" role="tabpanel"></div>',
    ...
    it('should handle removed tabs', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav__tabs" role="tablist">',
        '  <li class="nav__item">',
        '    <a class="nav__link nav__tab" href="#profile" role="tab" data-toggle="tab">',
        '      <button class="close"><span aria-hidden="true">&times;</span></button>',
        '    </a>',
        '  </li>',
        '  <li class="nav__item">',
        '    <a id="secondNav" class="nav__link nav__tab" href="#buzz" role="tab" data-toggle="tab">',
        '      <button class="close"><span aria-hidden="true">&times;</span></button>',
        '    </a>',
        '  </li>',
        '  <li class="nav__item">',
        '    <a class="nav__link nav__tab" href="#references" role="tab" data-toggle="tab">',
        '      <button id="btnClose" class="close"><span aria-hidden="true">&times;</span></button>',
        '    </a>',
        '  </li>',
        '</ul>',
        '<div class="tab__content">',
        '  <div role="tabpanel" class="tab__pane fade show active" id="profile">test 1</div>',
        '  <div role="tabpanel" class="tab__pane fade" id="buzz">test 2</div>',
        '  <div role="tabpanel" class="tab__pane fade" id="references">test 3</div>',
        '</div>'
      ].join('')
      ...
      secondNavEl.addEventListener('shown.bs.tab', () => {
        expect(fixtureEl.querySelectorAll('.nav__tab').length).toEqual(2)
        done()
      })
  ...
  describe('data-api', () => {
    it('should create dynamically a tab', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav__tabs" role="tablist">',
        '  <li class="nav__item"><a href="#home" class="nav__link active" role="tab">Home</a></li>',
        '  <li class="nav__item"><a id="triggerProfile" data-toggle="tab" href="#profile" class="nav__link" role="tab">Profile</a></li>',
        '</ul>',
        '<div class="tab__content">',
        '  <div class="tab__pane active" id="home" role="tabpanel"></div>',
        '  <div class="tab__pane" id="profile" role="tabpanel"></div>',
    ...
    it('selected tab should deactivate previous selected link in dropdown', () => {
      fixtureEl.innerHTML = [
        ...
        '  <li class="nav__item"><a class="nav__link" href="#home" data-toggle="tab">Home</a></li>',
        '  <li class="nav__item"><a class="nav__link" href="#profile" data-toggle="tab">Profile</a></li>',
        '  <li class="nav__item dropdown">',
        '    <a class="nav__link dropdown__toggle active" data-toggle="dropdown" href="#">Dropdown</>',
        '    <div class="dropdown__menu">',
        '      <a class="dropdown__item active" href="#dropdown1" id="dropdown1-tab" data-toggle="tab">@fat</a>',
        '      <a class="dropdown__item" href="#dropdown2" id="dropdown2-tab" data-toggle="tab">@mdo</a>',
        '    </div>',
        '  </li>',
        '</ul>'
      ].join('')
      ...
      expect(fixtureEl.querySelector('li:last-child .dropdown__menu a:first-child').classList.contains('active')).toEqual(false)
    })

    it('should handle nested tabs', done => {
      fixtureEl.innerHTML = [
        '<nav class="nav nav__tabs" role="tablist">',
        '  <a id="tab1" href="#x-tab1" class="nav__item nav__link" data-toggle="tab" role="tab" aria-controls="x-tab1">Tab 1</a>',
        '  <a href="#x-tab2" class="nav__item nav__link active" data-toggle="tab" role="tab" aria-controls="x-tab2" aria-selected="true">Tab 2</a>',
        '  <a href="#x-tab3" class="nav__item nav__link" data-toggle="tab" role="tab" aria-controls="x-tab3">Tab 3</a>',
        '</nav>',
        '<div class="tab__content">',
        '  <div class="tab__pane" id="x-tab1" role="tabpanel">',
        '    <nav class="nav nav__tabs" role="tablist">',
        '      <a href="#nested-tab1" class="nav__item nav__link active" data-toggle="tab" role="tab" aria-controls="x-tab1" aria-selected="true">Nested Tab 1</a>',
        '      <a id="tabNested2" href="#nested-tab2" class="nav__item nav__link" data-toggle="tab" role="tab" aria-controls="x-profile">Nested Tab2</a>',
        '    </nav>',
        '    <div class="tab__content">',
        '      <div class="tab__pane active" id="nested-tab1" role="tabpanel">Nested Tab1 Content</div>',
        '      <div class="tab__pane" id="nested-tab2" role="tabpanel">Nested Tab2 Content</div>',
        '    </div>',
        '  </div>',
        '  <div class="tab__pane active" id="x-tab2" role="tabpanel">Tab2 Content</div>',
        '  <div class="tab__pane" id="x-tab3" role="tabpanel">Tab3 Content</div>',
        '</div>'
      ].join('')
    ...
    it('should not remove fade class if no active pane is present', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav__tabs" role="tablist">',
        '  <li class="nav__item"><a id="tab__home" href="#home" class="nav__link" data-toggle="tab" role="tab">Home</a></li>',
        '  <li class="nav__item"><a id="tab__profile" href="#profile" class="nav__link" data-toggle="tab" role="tab">Profile</a></li>',
        '</ul>',
        '<div class="tab__content">',
        '  <div class="tab__pane fade" id="home" role="tabpanel"></div>',
        '  <div class="tab__pane fade" id="profile" role="tabpanel"></div>',
        '</div>'
      ].join('')

      const triggerTabProfileEl = fixtureEl.querySelector('#tab__profile')
      const triggerTabHomeEl = fixtureEl.querySelector('#tab__home')
    ...
    it('should not add show class to tab panes if there is no `.fade` class', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav__tabs" role="tablist">',
        '  <li class="nav__item">',
        '    <a class="nav__link nav__tab" href="#home" role="tab" data-toggle="tab">Home</a>',
        '  </li>',
        '  <li class="nav__item">',
        '    <a id="secondNav" class="nav__link nav__tab" href="#profile" role="tab" data-toggle="tab">Profile</a>',
        '  </li>',
        '</ul>',
        '<div class="tab__content">',
        '  <div role="tabpanel" class="tab__pane" id="home">test 1</div>',
        '  <div role="tabpanel" class="tab__pane" id="profile">test 2</div>',
        '</div>'
      ].join('')
    ...
    it('should add show class to tab panes if there is a `.fade` class', done => {
      fixtureEl.innerHTML = [
        ...
        '</ul>',
        '<div class="tab__content">',
        '  <div role="tabpanel" class="tab__pane fade" id="home">test 1</div>',
        '  <div role="tabpanel" class="tab__pane fade" id="profile">test 2</div>',
        '</div>'
      ].join('')
