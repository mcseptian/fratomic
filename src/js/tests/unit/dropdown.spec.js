...
describe('Dropdown', () => {
  ...
  describe('constructor', () => {
    it('should create offset modifier correctly when offset option is a function', () => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button href="#" class="btn dropdown__toggle" data-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
      ].join('')
  ...
  describe('toggle', () => {
    it('should toggle a dropdown', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button href="#" class="btn dropdown__toggle" data-toggle="dropdown" aria-expanded="false">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
    ...
    it('should not toggle a dropdown if the element is disabled', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button disabled href="#" class="btn dropdown__toggle" data-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
    ...
    it('should not toggle a dropdown if the element contains .disabled', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button href="#" class="btn dropdown__toggle disabled" data-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
  ...
  describe('hide', () => {
    it('should hide a dropdown', done => {
      ...
      const btnDropdown = fixtureEl.querySelector('[data-toggle="dropdown"]')
      const dropdownEl = fixtureEl.querySelector('.dropdown')
      const dropdownMenu = fixtureEl.querySelector('.dropdown__menu')
      const dropdown = new Dropdown(btnDropdown)
  ...
  describe('data-api', () => {
    ...
    it('should add class position-static to dropdown if boundary not scrollParent', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button href="#" class="btn dropdown__toggle" data-toggle="dropdown" data-boundary="viewport">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
    ...
    it('should not use popper.js if display set to static', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button href="#" class="btn dropdown__toggle" data-toggle="dropdown" data-display="static">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
    ...
    it('should remove "show" class if body is clicked, with multiple dropdowns', done => {
      fixtureEl.innerHTML = [
        ...
        '    <a class="dropdown__toggle" data-toggle="dropdown" href="#testmenu">Test menu <span class="caret"/></a>',
        '    <div class="dropdown__menu">',
        '      <a class="dropdown__item" href="#sub1">Submenu 1</a>',
        '    </div>',
        '  </div>',
        '</div>',
        '<div class="btn-group">',
        '  <button class="btn">Actions</button>',
        '  <button class="btn dropdown__toggle" data-toggle="dropdown"></button>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item" href="#">Action 1</a>',
        '  </div>',
        '</div>'
      ].join('')
      ...
      dropdownTestMenu.addEventListener('shown.bs.dropdown', () => {
        ...
        expect(fixtureEl.querySelectorAll('.dropdown__menu.show').length).toEqual(1)
        document.body.click()
      })

      dropdownTestMenu.addEventListener('hidden.bs.dropdown', () => {
        expect(fixtureEl.querySelectorAll('.dropdown__menu.show').length).toEqual(0)
        last.click()
      })
    ...
    it('should remove "show" class if body if tabbing outside of menu, with multiple dropdowns', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <a class="dropdown__toggle" data-toggle="dropdown" href="#testmenu">Test menu</a>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item" href="#sub1">Submenu 1</a>',
        '  </div>',
        '</div>',
      ...
      dropdownTestMenu.addEventListener('shown.bs.dropdown', () => {
        ...
        expect(fixtureEl.querySelectorAll('.dropdown__menu.show').length).toEqual(1, 'only one dropdown is shown')
      ...
      dropdownTestMenu.addEventListener('hidden.bs.dropdown', () => {
        expect(fixtureEl.querySelectorAll('.dropdown__menu.show').length).toEqual(0, '"show" class removed')
        last.click()
      })
    ...
    it('should skip disabled element when using keyboard navigation', done => {
      fixtureEl.innerHTML = [
        ...
        '  <button href="#" class="btn dropdown__toggle" data-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <a class="dropdown__item disabled" href="#sub1">Submenu 1</a>',
        '    <button class="dropdown__item" type="button" disabled>Disabled button</button>',
        '    <a id="item1" class="dropdown__item" href="#">Another link</a>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should skip hidden element when using keyboard navigation', done => {
      fixtureEl.innerHTML = [
        ...
        '  <button href="#" class="btn dropdown__toggle" data-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <button class="dropdown__item d-none" type="button">Hidden button by class</button>',
        '    <a class="dropdown__item" href="#sub1" style="display: none">Hidden link</a>',
        '    <a class="dropdown__item" href="#sub1" style="visibility: hidden">Hidden link</a>',
        '    <a id="item1" class="dropdown__item" href="#">Another link</a>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should focus next/previous element when using keyboard navigation', done => {
      fixtureEl.innerHTML = [
        ...
        '  <button href="#" class="btn dropdown__toggle" data-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown__menu">',
        '    <a id="item1" class="dropdown__item" href="#">A link</a>',
        '    <a id="item2" class="dropdown__item" href="#">Another link</a>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should ignore keyboard events for <input>s and <textarea>s within dropdown__menu, except for escape key', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button href="#" class="btn dropdown__toggle" data-toggle="dropdown">Dropdown</button>',
        '  <div class="dropdown__menu">',
