/*!
  * Bootstrap bundle v0.0.1 (https://github.com/mcseptian/fratomic)
...
(function (global, factory) {
  ...
  (global = global || self, global.bs = factory(global.Popper));
  ...
  var ClassName$4 = {
    ...
    DROPRIGHT: 'dropright',
    DROPLEFT: 'dropleft',
    MENURIGHT: 'dropdown__menu-right',
  ...
  var Selector$4 = {
    ...
    VISIBLE_ITEMS: '.dropdown__menu .dropdown__item:not(.disabled):not(:disabled)'
  };
  var AttachmentMap = {
    TOP: 'top-start',
    TOPEND: 'top-end',
    ...
    _proto._activate = function _activate(target) {
      ...
      if (link.classList.contains(ClassName$8.DROPDOWN_ITEM)) {
        ...
        SelectorEngine.parents(link, Selector$8.NAV_LIST_GROUP).forEach(function (listGroup) {
          ...
          }); // Handle special case when .nav__link is inside .nav__item
  ...
  var Selector$9 = {
    ...
    DROPDOWN_TOGGLE: '.dropdown__toggle',
    DROPDOWN_ACTIVE_CHILD: ':scope > .dropdown__menu .active'
  };
  /**
   * ------------------------------------------------------------------------
   * Class Definition
